    ...
    public class MyUser {
        ...
        @OneToMany(mappedBy = "testLead")
        private Set<Equipe> equipesDirigees = new HashSet<>();

        // Ajoutez le getter manquant
        public Set<Equipe> getEquipesDirigees() {
            return equipesDirigees;
        }

        // Ajoutez également le setter pour la cohérence
        public void setEquipesDirigees(Set<Equipe> equipesDirigees) {
